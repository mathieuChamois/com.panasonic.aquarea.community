...
// L’IP est utilisée pour contourner les résolutions DNS défectueuses de Homey.
// Le servername/authority restent le nom public afin de conserver TLS et gRPC.
const GRPC_IP    = '79.57.79.152';
...
class AquareaHomeClient {
  ...
  async _sendOperationOnce(macAddress, frame) {
    ...
    return new Promise((resolve, reject) => {
      const client = http2.connect(`https://${GRPC_IP}:${GRPC_PORT}`, { servername: GRPC_HOST });
